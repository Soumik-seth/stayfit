...
export default function ConsultationPlansPage() {
  ...
  const [editingPlan, setEditingPlan] =
    useState<ConsultationPlan | null>(null);
  ...
  const fetchPlans = async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error ||
            "Failed to fetch consultation plans"
        );
      }
      ...
      console.error(
        "Fetch consultation plans error:",
        error
      );
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error ||
            "Failed to save consultation plan"
        );
      }
  ...
  const togglePlanStatus = async (
    ...
    try {
      ...
      console.error(
        "Toggle consultation plan status error:",
        error
      );
  ...
  const deletePlan = async (
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.error ||
            "Failed to delete consultation plan"
        );
      }
      ...
      console.error(
        "Delete consultation plan error:",
        error
      );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500 sm:text-sm">
                Manage video consultation plans and pricing
              </p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
            ...
            <h2 className="mt-4 text-lg font-bold text-gray-900">
              No Consultation Plans Yet
            </h2>

            <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
              Create your first video consultation
              plan to make it available for users.
            </p>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  {editingPlan
                    ...
                    : "Create a new video consultation plan"}
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Example: 1 Month Consultation Plan"
