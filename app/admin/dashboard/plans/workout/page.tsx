          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500 sm:text-sm">
                Manage workout subscription plans and pricing
              </p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
            ...
            <p className="mx-auto mt-2 max-w-md text-sm text-gray-500">
              Create your first workout subscription
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  {editingPlan
                    ...
                    : "Create a new workout subscription plan"}
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Example: 1 Month Workout Plan"
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  placeholder={`Personalized workout schedule
Exercise guidance
Progress tracking
Workout support`}
                  rows={6}
