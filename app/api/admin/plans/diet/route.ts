...
export async function GET() {
  try {
    ...
    console.error("Diet plans GET error:", error);
...
export async function POST(request: Request) {
  try {
    ...
    console.error("Diet plans POST error:", error);
...
export async function PUT(request: Request) {
  try {
    ...
    console.error("Diet plans PUT error:", error);
...
export async function DELETE(request: Request) {
  try {
    ...
    console.error("Diet plans DELETE error:", error);
