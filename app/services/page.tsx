    ...
    <>
      ...
      <main className="min-h-screen overflow-hidden bg-white">
        ...
        <section className="relative overflow-hidden bg-[#0C4372] pt-[72px]">
          ...
          <div className="absolute bottom-[20%] left-[25%] h-2 w-2 animate-[floatSmall_4s_ease-in-out_infinite_1s] rounded-full bg-[#CAA035]/50" />

          <div className="absolute bottom-[25%] right-[25%] h-2 w-2 animate-[floatSmall_5s_ease-in-out_infinite_1s] rounded-full bg-white/30" />
        ...
        <section className="px-5 py-16 sm:px-8 md:py-20 lg:px-12 lg:py-24">
          ...
          <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-[#0C4372] px-6 py-14 text-center sm:px-10 sm:py-16 lg:px-16">
            ...
            <div className="absolute right-[20%] bottom-[25%] h-2 w-2 animate-[dotFloat_3s_ease-in-out_infinite_1s] rounded-full bg-[#CAA035]" />
